    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_id', models.UUIDField()),
                ('content_type', models.ForeignKey(limit_choices_to=models.Q(('app_label', 'library'), ('model', 'biblio')), on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_items', to='library.genre', verbose_name='Genres Tag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_id', models.UUIDField()),
                ('content_type', models.ForeignKey(limit_choices_to=models.Q(('app_label', 'library'), ('model', 'biblio')), on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_items', to='library.publisher', verbose_name='Publishers Tag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddIndex(
            model_name='author',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='library_aut_search__22eba9_gin'),
        ),
        migrations.AddIndex(
            model_name='cover',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['name'], name='library_pub_name_963899_idx'),
        ),
        migrations.AddIndex(
            model_name='biblio',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='library_bib_search__57dbda_gin'),
        ),
        migrations.AddIndex(
            model_name='biblio',
            index=models.Index(fields=['original_publication_date'], name='library_bib_origina_47694b_idx'),
        ),
        migrations.AddIndex(
            model_name='biblio',
            index=models.Index(fields=['language'], name='library_bib_languag_37d939_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='biblio',
