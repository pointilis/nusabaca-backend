    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='library.TaggedAuthor', to='library.Author', verbose_name='Authors')),
                ...
                ('genres', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='library.TaggedGenre', to='library.Genre', verbose_name='Genres')),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='modified_%(app_label)s_%(class)s', to=settings.AUTH_USER_MODEL)),
                ('publishers', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='library.TaggedPublisher', to='library.Publisher', verbose_name='Publishers')),
            ],
            options={
